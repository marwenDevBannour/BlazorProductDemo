...
{
    public class ShopingCartService : IShpingCartService
    {
        private readonly HttpClient _httpClient;

        public event Action<int> onshopingCatChanged;
        public ShopingCartService(HttpClient httpClient)
        {
            _httpClient = httpClient;
        }

        public void RaiseOnshopingCatChanged(int totalQte)
        {
            if (onshopingCatChanged != null)
            {
                onshopingCatChanged.Invoke(totalQte);
            }
        }
